...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class OnTrigger : MonoBehaviour
    {
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            {
                GameManagerEscape.Instance.candleCount++;
                if (GameManagerEscape.Instance.candleCount >= 3)
                {
                    SoundManagerEscape.instance.audioSource.clip = SoundManagerEscape.instance.candleLit;
                    SoundManagerEscape.instance.audioSource.Play();
                    //GameManagerEscape.Instance.window.GetComponent<BreakableWindow>().breakWindow();
                }
